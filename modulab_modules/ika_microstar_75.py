"""Modulab wrapper for IKA Microstar 75 (PyLabware)."""
...
class IkaMicrostar75Template(PylabwareModuleMixin, SimpleDriverTemplate):
    """Thread-executor Modulab wrapper around Microstar75Stirrer."""

    # 1) Module identity and metadata
    template_id = "pylabware.ika_microstar_75"
    interface_id = "ICustomDevice"
    display_name = "IKA Microstar 75"
    version = "1.0.0"
    description = "PyLabware-backed Modulab wrapper for IKA Microstar 75."
    vendor = "PyLabware"
    model = "Microstar75Stirrer"
    default_name = "IKA Microstar 75"
    ...
    PYLABWARE_MODULE = "PyLabware.devices.ika_microstar_75"
    PYLABWARE_CLASS = "Microstar75Stirrer"
...
DRIVER_TEMPLATE = build_simple_template(IkaMicrostar75Template)
