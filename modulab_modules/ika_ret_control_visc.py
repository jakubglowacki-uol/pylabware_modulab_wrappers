"""Modulab wrapper for IKA RET Control Visc (PyLabware)."""
...
class IkaRETControlViscTemplate(PylabwareModuleMixin, SimpleDriverTemplate):
    """Thread-executor Modulab wrapper around RETControlViscHotplate."""

    # 1) Module identity and metadata
    template_id = "pylabware.ika_ret_control_visc"
    interface_id = "IHeaterShaker"
    display_name = "IKA RET Control Visc"
    version = "1.0.0"
    description = "PyLabware-backed Modulab wrapper for IKA RET Control Visc."
    vendor = "PyLabware"
    model = "RETControlViscHotplate"
    default_name = "IKA RET Control Visc"
    ...
    driver_param_schema = {
        ...
        "device_name": {
            ...
            "required": False,
            "default": "IKA RET Control Visc",
        },
    }

    # 3) Instance state initialization
    PYLABWARE_MODULE = "PyLabware.devices.ika_ret_control_visc"
    PYLABWARE_CLASS = "RETControlViscHotplate"
...
DRIVER_TEMPLATE = build_simple_template(IkaRETControlViscTemplate)
