"""Modulab wrapper for Vacuubrand CVC 3000 (PyLabware)."""
...
class VacuubrandCVC3000Template(PylabwareModuleMixin, SimpleDriverTemplate):
    """Thread-executor Modulab wrapper around CVC3000VacuumPump."""

    # 1) Module identity and metadata
    template_id = "pylabware.vacuubrand_cvc_3000"
    interface_id = "ICustomDevice"
    display_name = "Vacuubrand CVC 3000"
    version = "1.0.0"
    description = "PyLabware-backed Modulab wrapper for Vacuubrand CVC 3000."
    vendor = "PyLabware"
    model = "CVC3000VacuumPump"
    default_name = "Vacuubrand CVC 3000"
    ...
    driver_param_schema = {
        ...
        "device_name": {
            ...
            "required": False,
            "default": "Vacuubrand CVC 3000",
        },
    }

    # 3) Instance state initialization
    PYLABWARE_MODULE = "PyLabware.devices.vacuubrand_cvc_3000"
    PYLABWARE_CLASS = "CVC3000VacuumPump"
...
DRIVER_TEMPLATE = build_simple_template(VacuubrandCVC3000Template)
