"""Modulab wrapper for Julabo CF41 (PyLabware)."""
...
class JulaboCF41Template(PylabwareModuleMixin, SimpleDriverTemplate):
    """Thread-executor Modulab wrapper around CF41Chiller."""

    # 1) Module identity and metadata
    template_id = "pylabware.julabo_cf41"
    interface_id = "ICoolerChiller"
    display_name = "Julabo CF41"
    version = "1.0.0"
    description = "PyLabware-backed Modulab wrapper for Julabo CF41."
    vendor = "PyLabware"
    model = "CF41Chiller"
    default_name = "Julabo CF41"
    ...
    PYLABWARE_MODULE = "PyLabware.devices.julabo_cf41"
    PYLABWARE_CLASS = "CF41Chiller"
...
DRIVER_TEMPLATE = build_simple_template(JulaboCF41Template)
