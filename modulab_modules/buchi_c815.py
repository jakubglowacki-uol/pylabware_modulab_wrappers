"""Modulab wrapper for Buchi C815 (PyLabware)."""
...
class BuchiC815Template(PylabwareModuleMixin, SimpleDriverTemplate):
    """Thread-executor Modulab wrapper around C815FlashChromatographySystem."""
    ...
    vendor = "PyLabware"
    model = "C815FlashChromatographySystem"
    default_name = "Buchi C815"
    ...
    PYLABWARE_MODULE = "PyLabware.devices.buchi_c815"
    PYLABWARE_CLASS = "C815FlashChromatographySystem"
...
DRIVER_TEMPLATE = build_simple_template(BuchiC815Template)
