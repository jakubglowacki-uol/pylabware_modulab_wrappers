"""Modulab wrapper for Buchi R300 (PyLabware)."""
...
class BuchiR300Template(PylabwareModuleMixin, SimpleDriverTemplate):
    """Thread-executor Modulab wrapper around R300Rotovap."""

    # 1) Module identity and metadata
    template_id = "pylabware.buchi_r300"
    interface_id = "ICustomDevice"
    display_name = "Buchi R300"
    version = "1.0.0"
    description = "PyLabware-backed Modulab wrapper for Buchi R300."
    vendor = "PyLabware"
    model = "R300Rotovap"
    default_name = "Buchi R300"
    ...
    PYLABWARE_MODULE = "PyLabware.devices.buchi_r300"
    PYLABWARE_CLASS = "R300Rotovap"
...
DRIVER_TEMPLATE = build_simple_template(BuchiR300Template)
