"""Modulab wrapper for Huber Petite Fleur (PyLabware)."""
...
class HuberPetiteFleurTemplate(PylabwareModuleMixin, SimpleDriverTemplate):
    """Thread-executor Modulab wrapper around PetiteFleurChiller."""

    # 1) Module identity and metadata
    template_id = "pylabware.huber_petite_fleur"
    interface_id = "ICoolerChiller"
    display_name = "Huber Petite Fleur"
    version = "1.0.0"
    description = "PyLabware-backed Modulab wrapper for Huber Petite Fleur."
    vendor = "PyLabware"
    model = "PetiteFleurChiller"
    default_name = "Huber Petite Fleur"
    ...
    driver_param_schema = {
        ...
        "device_name": {
            ...
            "required": False,
            "default": "Huber Petite Fleur",
        },
    }

    # 3) Instance state initialization
    PYLABWARE_MODULE = "PyLabware.devices.huber_petite_fleur"
    PYLABWARE_CLASS = "PetiteFleurChiller"
...
DRIVER_TEMPLATE = build_simple_template(HuberPetiteFleurTemplate)
