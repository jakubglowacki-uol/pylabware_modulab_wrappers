"""Modulab wrapper for IDEX MXII Valve (PyLabware)."""
...
class IdexMXIITemplate(PylabwareModuleMixin, SimpleDriverTemplate):
    """Thread-executor Modulab wrapper around IDEXMXIIValve."""

    # 1) Module identity and metadata
    template_id = "pylabware.idex_mxii"
    interface_id = "ICustomDevice"
    display_name = "IDEX MXII Valve"
    version = "1.0.0"
    description = "PyLabware-backed Modulab wrapper for IDEX MXII Valve."
    vendor = "PyLabware"
    model = "IDEXMXIIValve"
    default_name = "IDEX MXII Valve"
    ...
    driver_param_schema = {
        ...
        "device_name": {
            ...
            "required": False,
            "default": "IDEX MXII Valve",
        },
    }

    # 3) Instance state initialization
    PYLABWARE_MODULE = "PyLabware.devices.idex_mxii"
    PYLABWARE_CLASS = "IDEXMXIIValve"
...
DRIVER_TEMPLATE = build_simple_template(IdexMXIITemplate)
