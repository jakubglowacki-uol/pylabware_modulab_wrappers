"""Modulab wrapper for IKA RCT Digital (PyLabware)."""
...
class IkaRCTDigitalTemplate(PylabwareModuleMixin, SimpleDriverTemplate):
    """Thread-executor Modulab wrapper around RCTDigitalHotplate."""

    # 1) Module identity and metadata
    template_id = "pylabware.ika_rct_digital"
    interface_id = "IHeaterShaker"
    display_name = "IKA RCT Digital"
    version = "1.0.0"
    description = "PyLabware-backed Modulab wrapper for IKA RCT Digital."
    vendor = "PyLabware"
    model = "RCTDigitalHotplate"
    default_name = "IKA RCT Digital"
    ...
    PYLABWARE_MODULE = "PyLabware.devices.ika_rct_digital"
    PYLABWARE_CLASS = "RCTDigitalHotplate"
...
DRIVER_TEMPLATE = build_simple_template(IkaRCTDigitalTemplate)
